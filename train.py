...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/bsd2022.yaml', help='data.yaml path')
    ...
    parser.add_argument('--loop', type=int, default=1, help='loop number for box size finder')
